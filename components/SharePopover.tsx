...
export default function SharePopover({ artworkTitle, artworkUrl }: SharePopoverProps) {
      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className="absolute bottom-full left-0 mb-2 bg-white rounded-lg shadow-xl py-1 min-w-[160px] z-10"
          >
            {links.map((link) => (
              <a
                key={link.label}
            ...
            <button
              onClick={handleCopy}
              className="flex items-center gap-2.5 px-3 py-2 text-sm text-gray-700 hover:bg-gray-100 transition-colors w-full"
            >
              <svg className="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5}>
                <path
                  strokeLinecap="round"
                  strokeLinejoin="round"
                  d="M13.19 8.688a4.5 4.5 0 011.242 7.244l-4.5 4.5a4.5 4.5 0 01-6.364-6.364l1.757-1.757m9.86-2.556a4.5 4.5 0 00-1.242-7.244l-4.5-4.5a4.5 4.5 0 00-6.364 6.364L4.5 8.737"
                />
              </svg>
